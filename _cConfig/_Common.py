...
# QPROX_READER_FORCE_DUMP = True if _ConfigParser.get_set_value('QPROX_NFC', 'force^enable^dump', '1') == '1' else False
...
EDC_PAYMENT_DURATION = EDC_MOBILE_DURATION
...
def store_upload_failed_trx(trxid, pid='', amount=0, failure_type='', payment_method='', remarks=''):
    try:
        ...
        if payment_method.lower() in VIEW_CONFIG['all_qr_provider']:
