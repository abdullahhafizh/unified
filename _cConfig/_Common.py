...
BILL_NATIVE_MODULE = True if _ConfigParser.get_set_value('BILL', 'service^library', '1') == '0' else False
...
CONFIG_ALLOWED_BANK_CHECK_CARD_LOG = _ConfigParser.get_set_value('GENERAL', 'allowed^check^card^log', 'MANDIRI|BNI')
